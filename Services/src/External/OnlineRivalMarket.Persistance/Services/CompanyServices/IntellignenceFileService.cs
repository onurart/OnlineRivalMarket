...
public sealed class IntellignenceFileService : IIntellignenceFileService
{
    ...
    public IntellignenceFileService(IImagesFileCommandRepository imagesFileCommandRepository, IImagesFileQueryRepository imagesFileQueryRepository, ICompanyDbUnitOfWork unitOfWork, IContextService? contextService)
    {
