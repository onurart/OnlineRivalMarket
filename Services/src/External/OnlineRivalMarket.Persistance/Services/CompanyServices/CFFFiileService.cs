...
public class CFFFiileService : ICFFieldFileService
{
    ...
    public CFFFiileService(ICFFileCommandRepository cfFileCommandRepository, ICFQueryRepository cfFileQueryRepository, ICompanyDbUnitOfWork companyDbUnitOfWork, IContextService contextService)
    {
